...
%This function can apply tilting correction to all the ensembles of a transect. Data source can be any but you have to use the following generic ASCII template of WinRiver for data import. 
%This function can 
%a. Read ADCP velocity in beam coordinates WinRiver II ASCII file. 
